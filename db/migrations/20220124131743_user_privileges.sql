...
(
    ...
    user_privilege_id integer NOT NULL DEFAULT nextval('user_privileges_user_privilege_id_seq'::regclass),
    CONSTRAINT user_privileges_pkey PRIMARY KEY (user_privilege_id),
